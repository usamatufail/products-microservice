...
let LoggingInterceptor = LoggingInterceptor_1 = class LoggingInterceptor {
    ...
    intercept(context, next) {
        ...
        return next.handle().pipe((0, operators_1.tap)((res) => {
            ...
            this.insertMongo(method, url, statusCode, contentLength, userAgent, ip, responseTime, res, user === null || user === void 0 ? void 0 : user.user_id);
        }), (0, operators_1.catchError)((err) => {
            this.logger.error(err);
            return (0, rxjs_1.throwError)(() => err);
        }));
    }
    async insertMongo(method, url, responseStatus, contentLength, userAgent, ip, responseTime, responseBody, userId) {
        const logInfo = {
            method,
            url,
            responseStatus,
