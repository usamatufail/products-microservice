...
import { CreateProductDto, FullyUpdateProductDto, PartiallyUpdateProductDto, PartiallyUpdateProductVariantDto, ProductVariantDto } from './dto';
...
export declare class ProductsController {
    ...
    uploadImage(req: Request, id: string): Promise<Product & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    updateImages(req: Request, id: string): Promise<Product & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
